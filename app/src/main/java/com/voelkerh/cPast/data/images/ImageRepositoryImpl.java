...
public class ImageRepositoryImpl implements ImageRepository {
    ...
    private final MediaImageStore imageStore;

    public ImageRepositoryImpl(Context context, MediaImageStore imageStore) {
     ...
     * for the camera to write to. The returned {@link TempImageData} contains both
     ...
     *
     * @return a {@link TempImageData} object containing the file URI and path,
